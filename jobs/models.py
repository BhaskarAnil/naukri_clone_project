...
class LikedJob(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='liked_jobs')
    job = models.ForeignKey(Job, on_delete=models.CASCADE, related_name='liked_by')
...
class DislikedJob(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='disliked_jobs')
    job = models.ForeignKey(Job, on_delete=models.CASCADE, related_name='disliked_by')
