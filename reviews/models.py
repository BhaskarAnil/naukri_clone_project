...
class CompanyReview(models.Model):
    ...
    company = models.ForeignKey(
        Company, on_delete=models.CASCADE, db_column='company_id', related_name='reviews')
    user = models.ForeignKey(User, on_delete=models.CASCADE,
                             db_column='user_id', related_name='company_reviews')
...
class ReviewReply(models.Model):
    ...
    review = models.ForeignKey(
        CompanyReview, on_delete=models.CASCADE, related_name='replies')
...
class ReviewLike(models.Model):
    ...
    review = models.ForeignKey(
        CompanyReview, on_delete=models.CASCADE, related_name='likes')
    user = models.ForeignKey(
