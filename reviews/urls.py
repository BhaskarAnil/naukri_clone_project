...
urlpatterns = [
    ...
    path('companies/<int:company_id>/reviews/',
         companies_reviews_view, name='reviews'),
    path('companies/<int:company_id>/reviews/delete/',
    ...
    path('reviews/<int:review_id>/unlike/',
         unlike_review, name='unlike_review'),
]
